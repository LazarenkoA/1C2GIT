...
##### За процессом синхронизации можно заюлюдать через веб интерфейс, по url
http://localhost:2020
...
В web интерфейс выводятся как ошибки, та ки информация о том, что произошла очередная синхронизация
![screenshot](https://i.imgur.com/TtgQV4W.png)
